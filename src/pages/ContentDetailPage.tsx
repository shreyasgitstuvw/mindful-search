...
import { getContentById, MOCK_CONTENT, getTribeByName, formatNumber } from '@/lib/data';
...
export default function ContentDetailPage() {
  ...
  const tribe = getTribeByName(item.tribe);

  // Find similar content using this item's brain vector as query
  ...
  const similar = searchContent(MOCK_CONTENT, fakeQuery, 5)
